...
**Status:** Planned (2026-09-08, user report) · **Depends on:**
...
- [ ] **T-RL-01** Make the delay measurable. On resume (and on every
...
- [ ] **T-RL-02** Report the health where it is visible. If the state is
